...
bool UTPS_StateEffect_ExecuteTimer::InitObject(AActor* Actor)
{
	...
	if (myCharHealthComp)
	{
		...
		GEngine->AddOnScreenDebugMessage(-1, 2.0f, FColor::Blue, FString::Printf(TEXT("CharHealthComponent - True")));
	}
	else
	{
		GEngine->AddOnScreenDebugMessage(-1, 2.0f, FColor::Blue, FString::Printf(TEXT("CharHealthComponent - False")));
	}
